...
export default function Level1Map() {
    ...
    useEffect(() => {
            ...
            function createBoard() {
                ...
                board.createForah({ item: "forah", top: tile_size * 18, left: tile_size * 2 });
                board.createEnemy({ item: "merchant3", top: tile_size * 15, left: tile_size * 15 });
                board.createEnemy({ item: "merchant3", top: tile_size * 15, left: tile_size * 15 });
                board.createEnemy({ item: "merchant3", top: tile_size * 15, left: tile_size * 15 });
    ...
    return (
        <div id="level" className="level">
            <Image className="board-img" id="lvl" width="600px" height="600px" src="/MAP_LVL_03.gif" alt="AlphaBots Level 1" />
        </div>
    );
}
