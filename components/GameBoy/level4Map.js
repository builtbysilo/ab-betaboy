...
export default function Level1Map() {
    ...
    const { toggleSubmit, toggleGameOver } = useUpdateGame()
    ...
    useEffect(() => {
            ...
            function createBoard() {
                ...
                board.createTheo({ item: "theo", top: tile_size * 18, left: tile_size * 2 });
                board.createEnemy({ item: "merchant4", top: tile_size * 15, left: tile_size * 15 });
                board.createEnemy({ item: "merchant4", top: tile_size * 15, left: tile_size * 15 });
                board.createEnemy({ item: "merchant4", top: tile_size * 15, left: tile_size * 15 });
    ...
    return (
        <div id="level" className="level">
            <Image className="board-img" id="lvl" width="600px" height="600px" src="/MAP_LVL_04.gif" alt="AlphaBots Level 1" />
        </div>
    );
}
